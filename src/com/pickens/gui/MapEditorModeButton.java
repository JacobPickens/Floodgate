...
public class MapEditorModeButton extends GuiElement {

	Color color;
	
	public MapEditorModeButton(int x, int y, GuiManager gc) {
		super(x, y, gc);
		setWidth(256);
		setHeight(96);
	...
	public void render(Graphics g) {
		...
		g.drawString("Map Editor", x + width/2 - Fonts.MENU_TEXT.getWidth("Map Editor")/2, y + height/2 - Fonts.MENU_TEXT.getHeight("Map Editor")/2);
		g.setColor(color);
		g.fillRect(x, y, width, height);
	}
