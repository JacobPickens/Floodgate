...
public class MapSelectModeButton extends GuiElement {

	Color color;
	
	public MapSelectModeButton(int x, int y, GuiManager gc) {
		super(x, y, gc);
		setWidth(256);
		setHeight(96);
	...
	public void render(Graphics g) {
		...
		g.drawString("Map Select", x + width/2 - Fonts.MENU_TEXT.getWidth("Map Select")/2, y + height/2 - Fonts.MENU_TEXT.getHeight("Map Select")/2);
		g.setColor(color);
		g.fillRect(x, y, width, height);
	}
